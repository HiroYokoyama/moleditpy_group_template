...
GROUPS: List[Group] = [
    ...
    Group("CH2iPr", "*CC(C)C", ALKYL, "isobutyl"),
    Group("CH2tBu", "*CC(C)(C)C", ALKYL, "neopentyl"),
    ...
    Group("2-Norbornyl", "*C1CC2CCC1C2", CYCLOALKYL, "norbornyl bicycloheptyl"),
    ...
    Group("Styryl", "*C=Cc1ccccc1", UNSATURATED, "2-phenylvinyl cinnamyl"),
    ...
    Group("Xyl", "*c1c(C)cccc1C", ARYL, "2,6-dimethylphenyl xylyl"),
    ...
    Group("Dur", "*c1c(C)c(C)cc(C)c1C", ARYL, "duryl tetramethylphenyl"),
    Group("PMP", "*c1ccc(OC)cc1", ARYL, "4-methoxyphenyl anisyl"),
    ...
    Group(
        ...
        ARYL,
        "bis(trifluoromethyl)phenyl ArF",
    ),
    ...
    Group("9-Anthryl", "*c1cc2ccccc2c2ccccc12", ARYL, "anthracen-9-yl"),
    Group("1-Pyrenyl", "*c1cc2ccc3cccc4ccc(c1)c2c34", ARYL, "pyren-1-yl"),
    ...
    Group("3-Pyridazinyl", "*c1ccnnc1", HETEROARYL, "pyridazin-3-yl"),
    ...
    Group("Oxiranyl", "*C1CO1", SATURATED_HETERO, "epoxide glycidyl"),
    Group("Dioxolan-2-yl", "*C1OCCO1", SATURATED_HETERO, "protected aldehyde acetal"),
    Group("Dioxan-2-yl", "*C1OCCCO1", SATURATED_HETERO, "1,3-dioxane acetal"),
    Group("Dithian-2-yl", "*C1SCCCS1", SATURATED_HETERO, "1,3-dithiane umpolung"),
    ...
    Group(
        ...
        PG_O,
        "dimethoxytrityl nucleoside",
    ),
    Group("MMTr", "*C(c1ccc(OC)cc1)(c1ccccc1)c1ccccc1", PG_O, "monomethoxytrityl"),
    ...
    Group("DMB", "*Cc1ccc(OC)c(OC)c1", PG_N, "2,4-dimethoxybenzyl"),
    Group("Trt-N", "*C(c1ccccc1)(c1ccccc1)c1ccccc1", PG_N, "N-trityl"),
    Group("Bus", "*S(=O)(=O)C(C)(C)C", PG_N, "tert-butylsulfonyl"),
    Group("tBS", "*S(=O)C(C)(C)C", PG_N, "tert-butanesulfinyl Ellman"),
    # --- Silyl ---
    ...
    Group("Bs", "*S(=O)(=O)c1ccccc1", SULFUR, "besyl benzenesulfonyl Ph-SO2"),
    Group(
        "4-Ns",
    ...
    Group(
        ...
        SULFUR,
        "nosyl 2-nitrobenzenesulfonyl Fukuyama",
    ),
    ...
    Group("SPh", "*Sc1ccccc1", SULFUR, "phenylthio thiophenyl"),
    ...
    Group("SO2Ph", "*S(=O)(=O)c1ccccc1", SULFUR, "phenylsulfonyl"),
    # --- Phosphorus ---
    ...
    Group("OMe-PEG3", "*OCCOCCOC", FUNCTIONAL, "PEG oligoethylene glycol"),
    ...
    Group("Arg", "*CCCNC(N)=N", SIDECHAIN, "arginine guanidino"),
    Group("His", "*Cc1c[nH]cn1", SIDECHAIN, "histidine imidazolylmethyl"),
    Group("Phe", "*Cc1ccccc1", SIDECHAIN, "phenylalanine benzyl"),
    Group("Tyr", "*Cc1ccc(O)cc1", SIDECHAIN, "tyrosine hydroxybenzyl"),
    Group("Trp", "*Cc1c[nH]c2ccccc12", SIDECHAIN, "tryptophan indolylmethyl"),
